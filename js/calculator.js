...
function calculateVolume() {
    ...
    <div class="dato-resultado"><img class="warning-sing" src="images/attention.svg" alt="Signo de alerta"><span class="cantidad-span" id="texto-atención" style="color: #c43f35">¡La altura ingresada excede la capacidad del tanque!</span></div>
